...
func (uc *UserCreate) SetNillableAllStables(s *string) *UserCreate {
	if s != nil {
		uc.SetAllStables(*s)
	}
	return uc
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.TelegramId(); !ok {
		return &ValidationError{Name: "TelegramId", err: errors.New(`ent: missing required field "User.TelegramId"`)}
	}
	if _, ok := uc.mutation.RegTime(); !ok {
		return &ValidationError{Name: "RegTime", err: errors.New(`ent: missing required field "User.RegTime"`)}
	}
	return nil
}
