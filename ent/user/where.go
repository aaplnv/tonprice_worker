...
// ActiveStable applies equality check predicate on the "ActiveStable" field. It's identical to ActiveStableEQ.
func ActiveStable(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldActiveStable), v))
	})
}
...
// ActiveStableEQ applies the EQ predicate on the "ActiveStable" field.
func ActiveStableEQ(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldActiveStable), v))
	})
}

// ActiveStableNEQ applies the NEQ predicate on the "ActiveStable" field.
func ActiveStableNEQ(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldActiveStable), v))
	})
}

// ActiveStableIn applies the In predicate on the "ActiveStable" field.
func ActiveStableIn(vs ...string) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldActiveStable), v...))
	})
}

// ActiveStableNotIn applies the NotIn predicate on the "ActiveStable" field.
func ActiveStableNotIn(vs ...string) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldActiveStable), v...))
	})
}

// ActiveStableGT applies the GT predicate on the "ActiveStable" field.
func ActiveStableGT(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldActiveStable), v))
	})
}

// ActiveStableGTE applies the GTE predicate on the "ActiveStable" field.
func ActiveStableGTE(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldActiveStable), v))
	})
}

// ActiveStableLT applies the LT predicate on the "ActiveStable" field.
func ActiveStableLT(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldActiveStable), v))
	})
}

// ActiveStableLTE applies the LTE predicate on the "ActiveStable" field.
func ActiveStableLTE(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldActiveStable), v))
	})
}

// ActiveStableContains applies the Contains predicate on the "ActiveStable" field.
func ActiveStableContains(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.Contains(s.C(FieldActiveStable), v))
	})
}

// ActiveStableHasPrefix applies the HasPrefix predicate on the "ActiveStable" field.
func ActiveStableHasPrefix(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.HasPrefix(s.C(FieldActiveStable), v))
	})
}

// ActiveStableHasSuffix applies the HasSuffix predicate on the "ActiveStable" field.
func ActiveStableHasSuffix(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.HasSuffix(s.C(FieldActiveStable), v))
	})
}

// ActiveStableIsNil applies the IsNil predicate on the "ActiveStable" field.
func ActiveStableIsNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldActiveStable)))
	})
}

// ActiveStableNotNil applies the NotNil predicate on the "ActiveStable" field.
func ActiveStableNotNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldActiveStable)))
	})
}

// ActiveStableEqualFold applies the EqualFold predicate on the "ActiveStable" field.
func ActiveStableEqualFold(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EqualFold(s.C(FieldActiveStable), v))
	})
}

// ActiveStableContainsFold applies the ContainsFold predicate on the "ActiveStable" field.
func ActiveStableContainsFold(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldActiveStable), v))
	})
}
